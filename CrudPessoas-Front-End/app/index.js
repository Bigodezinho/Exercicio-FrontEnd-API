function CarregarTelaCadastroPessoa(){  
  window.location = "./module/pessoa/criarPessoa.html";
}
function CarregarTelaListagemPessoas(){
  window.location = "./module/pessoa/listarPessoa.html";
}

// async function CarregarTelaListagemPessoas(){

//   let telaPrincipal = document.querySelector('#tela-selecionada');

//   let telaAcarregar = await CarregarTemplate('pessoa/listarPessoa');

//   let elementJs = document.createElement('script');

//   let scriptJs = await CarregarJs('pessoa/listarPessoa');

  
//   //telaPrincipal.innerHTML = telaAcarregar;
// }
